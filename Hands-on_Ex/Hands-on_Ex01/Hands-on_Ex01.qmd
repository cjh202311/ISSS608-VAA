...
![](https://r4va.netlify.app/chap01/img/image1.jpg){width="60" height="60"} is an R package for **declaratively** creating **data-driven** graphics based on ***The Grammar of Graphics***
...
-   There are two ways to use these functions:
    ...
    -   add a function and override the default geom, or`stat_()`
...
### **Working with stat - the method`geom()`**
